    ...
    <footer className="bg-dark text-white/80 pt-16 border-t border-white/10">
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-[1.5fr_1fr_1fr] gap-12 md:gap-16 pb-12 border-b border-white/10">
          ...
          <div>
            <div className="flex items-center gap-3 mb-5">
              ...
              <span className="text-white font-heading font-extrabold tracking-widest text-lg">DOOKE CONSULTING</span>
            </div>
            <p className="text-white/60 text-sm leading-relaxed mb-6">
              {company.slogan} — Division numérique du groupe Dooke Corporation. Spécialisée en développement logiciel, web et mobile.
            </p>
          ...
          {/* Navigation */}
          <div>
            <h4 className="text-white font-heading font-bold text-base uppercase tracking-wider mb-6">Navigation</h4>
          ...
          {/* Sectors / Social */}
          <div>
            <h4 className="text-white font-heading font-bold text-base uppercase tracking-wider mb-6">Réseaux sociaux</h4>
            <ul className="flex flex-col gap-3">
              <li>
                <a
        ...
        <div className="py-6 flex flex-col md:flex-row justify-between items-center text-white/50 text-sm gap-4">
          <p>&copy; {new Date().getFullYear()} Dooke Consulting. Une division de Dooke Corporation.</p>
          <p className="flex items-center gap-2">
            <i className="fa fa-shield"></i> {company.slogan}
          </p>
        </div>
      </div>
    </footer>
