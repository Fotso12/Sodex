      ...
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            <h1 className="text-3xl md:text-4xl font-black text-white mt-3 mb-4">Mise en sécurité</h1>
            <div className="w-12 h-1 bg-primary mb-6" />
            <p className="text-white/60 text-base leading-relaxed mb-6">Systèmes de sécurité, protection incendie, conformité et audit sécurité.</p>
            <ul className="space-y-3">
              <li className="flex items-start gap-3 text-white/50 text-sm"><i className="fa fa-check-circle text-primary mt-0.5 flex-shrink-0"></i><span>Audit et diagnostic sécurité des bâtiments et installations industrielles.</span></li>
              <li className="flex items-start gap-3 text-white/50 text-sm"><i className="fa fa-check-circle text-primary mt-0.5 flex-shrink-0"></i><span>Installation de systèmes de détection incendie et d&apos;extinction automatique.</span></li>
              <li className="flex items-start gap-3 text-white/50 text-sm"><i className="fa fa-check-circle text-primary mt-0.5 flex-shrink-0"></i><span>Mise en conformité réglementaire et certification des équipements.</span></li>
              <li className="flex items-start gap-3 text-white/50 text-sm"><i className="fa fa-check-circle text-primary mt-0.5 flex-shrink-0"></i><span>Formation des équipes à la sécurité et aux gestes de premiers secours.</span></li>
            </ul>
