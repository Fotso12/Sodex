      ...
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            <h1 className="text-3xl md:text-4xl font-black text-white mt-3 mb-4">Bâtiment & Travaux Publics</h1>
            <div className="w-12 h-1 bg-primary mb-6" />
            <p className="text-white/60 text-base leading-relaxed mb-6">Génie civil, construction d&apos;infrastructures, routes, ponts et bâtiments.</p>
            <ul className="space-y-3">
              <li className="flex items-start gap-3 text-white/50 text-sm"><i className="fa fa-check-circle text-primary mt-0.5 flex-shrink-0"></i><span>Plus de 50 projets de construction réalisés en Afrique et en Europe.</span></li>
              <li className="flex items-start gap-3 text-white/50 text-sm"><i className="fa fa-check-circle text-primary mt-0.5 flex-shrink-0"></i><span>Expertise en fondations, structures béton armé et charpentes métalliques.</span></li>
              <li className="flex items-start gap-3 text-white/50 text-sm"><i className="fa fa-check-circle text-primary mt-0.5 flex-shrink-0"></i><span>Maîtrise des normes de construction internationales (ISO, Eurocodes).</span></li>
              <li className="flex items-start gap-3 text-white/50 text-sm"><i className="fa fa-check-circle text-primary mt-0.5 flex-shrink-0"></i><span>Équipes pluridisciplinaires : ingénieurs, chefs de chantier, techniciens.</span></li>
            </ul>
